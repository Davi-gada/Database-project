...
if(isset($_COOKIE["username"])) {
   ...
   $sql = "select * from DINE_IN where cname='$_POST[cname]'";
   ...
   if($result->num_rows != 0)
   {
    ...
    echo "<td>$rec[cname]</td>";
      ...
      echo "<p>CUSTOMER $_POST[cname] has no DINE_IN Orders.</p>";
