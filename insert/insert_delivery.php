...
if(isset($_COOKIE["username"])){
   ...
   echo "<form action=\"insertdelivery.php\" method=post>";
   ...
   {
      echo "Delivery Time: <input type=text name=\"deltime\" size=4> <br><br>";
      echo "Address: <input type=text name=\"address\" size=10> <br><br>";
	 ...
	 echo "<option value='$val[cname]'>$val[cname]</option>";
      ...
      echo "<input type=submit name=\"submit\" value=\"Add DELIVERY Order\">";
   }
   else
   {
